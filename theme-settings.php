...
/**
 * USAGE:
 * 1 - To use this file replace "dudenhofer" with the name of
...
// Replace 'dudenhofer' with your themes name, eg:
// function your_themes_name_form_system_theme_settings_alter(&$form, &$form_state)
function dudenhofer_form_system_theme_settings_alter(&$form, &$form_state)  {
